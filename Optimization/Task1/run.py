...
def main():
    ...
    x_min, f_min, code, hist = min_brent(func_a, -0.5, 0.5, disp=True, trace=True)
    # x_min, f_min, code, hist = min_cubic(d_func_a, -0.5, 0.5, disp=True, trace=True)
    # x_min, f_min, code, hist = min_brent_der(d_func_a, -0.5, 0.5, disp=True, trace=True)
    print(hist['n_evals'])

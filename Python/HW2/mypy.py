...
def print_primitive_score(seq1, seq2):
	...
	print(res)
	print(seq2)
	print('%d, (%d/%d), %.2f' % (overlap_count, overlap_count, max_len, overlap_count / float(max_len)))
	print()


def get_score(seq1, seq2, matrix):
	assert isinstance(seq1, str)
	assert isinstance(seq2, str)
...
if __name__ == '__main__':
	print('1) Сравнение')
	print_primitive_score('ALIGNMENTS', 'ALIGDVENTS')
	print_primitive_score('ALIGDPVENTS', 'ALIGN-MENTS')

	print('2) Оценивание')
	print(get_score('AGCATCGCTCT', 'AGCATCGTTTT', DNA_2))
	print(get_score('ALIGNMENT', 'AYIPNVENT', BLOSUM62))
	print(get_score('ALIGDPPVENTS', 'ALIGN--MENTS', BLOSUM62))
	print(get_score('ALIGDPPVENTS', '--ALIGNMENTS', BLOSUM62))
